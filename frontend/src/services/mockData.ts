export const mockProfiles = [
  {
    ...
    skills: ["React", "Node", "TypeScript", "PostgreSQL", "Docker", "Solidity"],
...
export const mockProjects = [
  {
    ...
    roles: [
      ...
      { id: "r2", title: "Backend co-founder", description: "Build scalable microservices and integrate LLM inference endpoints.", skillsRequired: ["Node", "Docker", "PostgreSQL"], isFilled: false }
    ],
    milestones: [
